"""
Monte Carlo BER Simulation for SEFDM + KNN-IEG IRS
...
from src.grouping import knn_grouping, grouped_channel
...
Q          = 250       # Number of groups for KNN
...
def main():
    print("=" * 60)
    print("  SEFDM + KNN-IEG IRS -- Monte Carlo BER Simulation")
    ...
    plt.title("BER Performance - SEFDM + KNN-IEG IRS\n"
